...
<form>
    ...
    if(empty($_SESSION['user_name'])){
        header("Location:index.php?error=您还未登录，请先登录！");
    }
    ?>
</form>
...
<div class="container" >
    <div id="heading">
        <form id="seachForm" action="baiduziye.php" method="post">
            ...
            <div id="keywords_border" style="display: none;z-index:999;width: 400px;position:relative;height: 200px;border: 1px solid beige;background-color:#f9f9f9;;margin-top:-17px;margin-left: 215px;">
...
<!--                    <button type="button" class="btn btn-info " data-toggle="modal" data-target=".fade"><a onclick='return CheckDelete()' href="reset.php" style="color: white">用户注销</button>-->
<!--                    注销用户-->
                    <div class="btn-group"><button class="btn btn-info"  id="dLabel" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"><?php echo $_GET['name']; ?><span class="caret"></span></button>
                        <div class="dropdown-menu " aria-labelledby="dLabel" style="min-width: 50%;" >
                            <li ><a href="#">我的百科</a></li>
                            <li><a href="#">我的任务</a></li>
                            <li><a href="userCenter.php">我的词条</a></li>
                            <li><a onclick='return CheckDelete()' href="reset.php">用户注销</a></li>
                        </div></div>
    ...
    <div id="content-body">
        ...
        <div class="vbaike">
            <h3>冷知识</h3>
            <div class="vtitle">
                <a href="#"; target="_blank" class="knowledge-title">喝牛奶为啥会变白</a>
            </div>
...
<a  href="#top" class="top" ><image src="images/回到顶部.gif"></image></a>
